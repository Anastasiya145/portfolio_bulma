        ...
        <div className="columns is-desktop">
          ...
          <div className="column">
            <h2 className="aboutme-page__subtitle subtitle mt-4">
              I'm a Software Developer with 3 years of experience in JS,
              TypeScript, HTML, CSS, Preprocessors, and React.js/Vue.js.
            </h2>
            <p className="">
              ...
              estimation, and organization.
            </p>
            <p className="">
              👨‍🎓 I have an Upper-Intermediate level of English and French, and I
              speak and write these languages well.
            </p>
            <p className="">
              👨‍🎓 During this time, I was able to increase my expertise in
              several areas:
            </p>
          </div>
        </div>
